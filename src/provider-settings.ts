...
const BUILT_IN_GITHUB_PROVIDER: ProviderSettings = {
  ...
  operations: {
    ...
    review: { args: ["api", "repos/{repo}/pulls/{number}/reviews/{reviewId}", "--include"] },
    reviewCommentsForReview: { args: ["api", "repos/{repo}/pulls/{number}/reviews/{reviewId}/comments?per_page=100&page={page}", "--include"] },
    ...
    submitReview: { args: ["api", "repos/{repo}/pulls/{number}/reviews", "--include", "--method", "POST", "--input", "{payloadPath}"] },
  ...
  fields: {
    ...
    submissionBody: ["body"],
    commentId: ["id"],
    commentReviewId: ["pull_request_review_id"],
    ...
    commentPath: ["path"],
    commentLine: ["line"],
    commentSubjectType: ["subject_type"],
    commentSide: ["side"],
    commentStartLine: ["start_line"],
    commentStartSide: ["start_side"],
    commentCommitId: ["commit_id"],
    commentOriginalCommitId: ["original_commit_id"],
    commentOriginalLine: ["original_line"],
    commentOriginalStartLine: ["original_start_line"],
  },
  capabilities: {
    atomicReview: true,
